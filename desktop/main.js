...
const { decodeFile, encodeFile, inspectFile, preflightEncodeFile } = require("../src/file-ops");

const APP_ICON_PATH = path.join(__dirname, "..", "Icon", "Antc.ico");
...
function registerIpc() {
  ...
  ipcMain.handle("atl:preflight", (_, payload) => safeHandle(() => preflightEncodeFile(payload)));
